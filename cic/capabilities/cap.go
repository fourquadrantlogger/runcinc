//  copyfrom github.com/opencontainers/runc/libcontainer/capabilities/capabilities.go
...
func New(capConfig *Capabilities) (*Caps, error) {
	var (
		err error
		c   Caps
	)
	...
	if len(unknownCaps) > 0 {
		logrus.Warn("New(capabilities) ignoring unknown or unavailable capabilities: ", mapKeys(unknownCaps))
	}
	return &c, nil
}
